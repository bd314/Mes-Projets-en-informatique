...
$("#sign-up-form").validate({
	...
	messages: {
		...
		username: {
			required: "Vous avez besoin d'un nom d'utilisateur!",
			minlength: $.format("Entrez au moins {0} caractères"),
			remote: jQuery.format("Nom d'utilisateur déjà utilisé.")
		},
		password: {
			required: "Créer un mot de passe",
			minlength: $.format("Entrez au moins {0} caractères")
		},
		password_confirm: {
		...
		email: {
			required: "Quelle est votre adresse e-mail ?",
			email: "Votre email n'est pas valide.",
			remote: jQuery.format("Adresse e-mail déjà utilisée.")
		}
   },
	errorClass: 'error',
	validClass: 'success',
