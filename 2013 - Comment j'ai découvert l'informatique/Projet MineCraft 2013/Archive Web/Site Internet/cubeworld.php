    ...
    <div class="container"> <!-- délimite la largeur de la page -->
      ...
      <div class="nav-collapse"> <!-- La zone de menu rétractable pour les mobiles -->
        ...
        <li id="fichier" class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="index.php">MineCraft</a>
          ...
          <li class="active"><a href="cubeworld.php">CubeWorld</a></li>
...
<div class="hero-unit"> 
    <center> <img src="images/cubeworld/cb.jpg" class="img-rounded"></center> 
  <p> </p>
  <p> </p>
  </br>
  <center><p>Bientot : Sur MineCryms !</p></center>
  </br> </br>
