...
#define DATA_PIN D7 // hardware SPI pin SCK
#define CLOCK_PIN D8 // hardware SPI pin SCK
#define NUM_LEDS 76
...
uint16_t animateSpeed = 800;            //Number of frames to increment per loop
uint8_t  animation = 10;    //Active animation
uint8_t brightness = 100;    //Global brightness percentage

void setup()
{
  LEDS.addLeds<WS2801, DATA_PIN, CLOCK_PIN, RGB>(strip, NUM_LEDS);
